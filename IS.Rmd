...
boundary <- st_read("C:/WEEK4/data/ad_boundary/boundary.shp")
  school <- st_read("C:/WEEK4/data/school/school.shp") 
  hospital <- st_read("C:/WEEK4/data/hospitals/Jiaxing_hos.shp")
  busstop <- st_read("C:/WEEK4/data/busstop/Jiaxing_busstop.shp")
  restaurant <- st_read("C:/WEEK4/data/restaurants/Jiaxing_res.shp")
  greenspace <- st_read("C:/WEEK4/data/greenspace/greenspace.shp")
  leis <- st_read("C:/WEEK4/data/leisure/yule.shp")
  public <- st_read("C:/WEEK4/data/public_service/shenghuo.shp")
  shopping <- st_read("C:/WEEK4/data/shopping/shopping.shp")
  weibo <- st_read("C:/WEEK4/data/weibo_sa/weibo_sa.shp")
